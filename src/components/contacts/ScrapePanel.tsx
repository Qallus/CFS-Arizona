...
const SCRAPE_METHODS = [
  ...
  { 
    ...
    examples: [
      { name: 'AIA (American Institute of Architects)', url: 'https://www.aia.org/' },
...
export function ScrapePanel({ onContactsScraped }: ScrapePanelProps) {
        ...
        <Card className="bg-card/50 border-border">
          ...
          <CardContent>
            <p className="text-muted-foreground text-sm mb-6">
              Select a scraping method to discover and import new contacts from various sources.
            </p>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Input
                        ...
                        placeholder="CEO, Marketing Director, Architect, etc."
                      />
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          className="bg-secondary border-border"
                          placeholder="Architecture, Real Estate, etc."
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        className="bg-secondary border-border"
                        placeholder="#architect, #realestate"
                      />
                    </div>
                  </div>
                )}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          className="bg-secondary border-border"
                          placeholder="Architecture Firms, Law Offices, etc."
                        />
                      </div>
                      <div>
                        <label className="block text-sm text-muted-foreground mb-1">Location</label>
          ...
          <CardContent>
            {jobs.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground text-xs mt-1">Select a method and start scraping</p>
              </div>
            ) : (
        ...
        <Card className="bg-card/50 border-border mt-6">
          ...
          <CardContent>
            <ul className="text-sm text-muted-foreground space-y-2">
              <li>• Use Google Maps for local business leads</li>
              <li>• LinkedIn is great for B2B contacts</li>
              <li>• Custom URL scraping works for association directories like AIA</li>
              <li>• Combine with Enrich tab to fill in missing data</li>
            </ul>
          </CardContent>
        </Card>
      </div>
